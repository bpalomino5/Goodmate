    ...
    <>
      <View>
        ...
        <Text style={{ fontSize: 16, color: "gray", marginBottom: 10 }}>
          Rent items can be divided evenly in price amongst specific roommates.
          If no assignment is made the item will be displayed to all but not
          included in totals. Select an item to get started.
        </Text>
      </View>
      <View
